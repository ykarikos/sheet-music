...
% 1
  ...
  \time 3/2 a,1.\cresc | \time 4/2 a1 a2 a |
% 2
  c1 e | \time 5/2 d1.\mf d1 | R1*5/2 |
  \time 3/2 R1. | R | R | R |
...
% 5
  cis1-\subF cis2 cis cis | r2 cis4 cis cis2 cis | cis1 cis4 r a2(-\subP | h) h h1 |
  c4 r\mf c2.\< h4 | a(\f g) f( e) g2( | a h1) | c1. | r2 r\pp a( | a) h c1 |
% 6
  ces2 r des( | des4) b c2. b4 | b2( g1) | f2 r1 r | R\breve |
  R\breve | R1. | R\breve | r2\mp f( g) | as g g | 
% 7  
  f f( e) | f1\< g1. | r2\mf \quiTollis g4( |
% 8
  g1.)\< | b2(\f a1) | a1. c4 r r2 | d( c1) | b c2 c |
