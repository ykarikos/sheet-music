...
upperOne = \relative c' {
  ...
  \clef bass <b g es>2. |
  \clef treble << {c4 d es16 f g8} \\ {as,4 as g8 b} >> | \break
...
lowerOne = \relative c, {
  ...
  f f f | es es es | <b'' es,> <as f> g | as as, b | c c c |
  << {s4 b'8. as16 g4} \\ {b,4 d es} >> |
  as, <f' b,> b,, | es2 r4 |

  % verse
  es'4 es es | b b b | <g' c,> <g c,> <g c,> | <g g,> <g g,> <es as,> |
  es, es es | <es' as,> <f f,> es, | b' b b | as as as | g g g |
